...
namespace Application.Repositories
{
    ...
    {
        //creating instances of the registered services 
        private readonly ApplicationDbContext dbContext;
        private readonly IMapper mapper;
        private readonly JwtSettings jwtSettings;

        //Injectng services via a ctor
        public AuthRepository(ApplicationDbContext dbContext, IMapper mapper,IOptions<JwtSettings>jwtSettings)
        {
